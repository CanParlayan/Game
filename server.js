...
var Game = require('./app/gameSet.js');
var GameStatus = require('./app/gameStatus.js');
const path = require("path");
//io.on("connection", socket => { "10.110.111.18" });
const server = app.listen(8900, '10.110.111.18');
...
io.connect('http://10.110.111.18:8182');
io.on('connection', function(socket) {
  console.log((new Date().toISOString()) + ' ID ' + socket.id + ' connected.');
  io.connect('http://10.110.111.18:8182');
  require('./io/index.js')(app);  
